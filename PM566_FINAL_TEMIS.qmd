...
ggplot(Zip_Discordance_List) + geom_sf(mapping = aes(geometry = geometry, fill = ZIP_Discord_Prop)) + 
  theme_classic() +
  labs(title = 'Proportion of Injuries per Zip Code of Children from Another Zip Code') +
  scale_fill_continuous(name = "Proportion Different\nHome Zip Code")
